...
public class JournalEntryDbSchema {
  ...
  /**
   * An inner class to describe to describe the table. The JournalEntryTable class only exists to
   * define the String constants needed to describe the moving pieces of the table definition.
   */
