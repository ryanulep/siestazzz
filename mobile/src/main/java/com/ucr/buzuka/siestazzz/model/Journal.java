...
public class Journal {
  ...
  private static ContentValues getContentValues(JournalEntry journalEntry) {
    ...
    values.put(JournalEntryDbSchema.JournalEntryTable.Cols.SLEEPDATEANDTIME,
        journalEntry.getSleepDateAndTime().getTime());
    values.put(JournalEntryDbSchema.JournalEntryTable.Cols.WAKEDATEANDTIME,
        journalEntry.getWakeDateAndTime().getTime());
    values.put(JournalEntryDbSchema.JournalEntryTable.Cols.MOTIONDATAPATH,
        journalEntry.getMotionDataPath());
    values.put(JournalEntryDbSchema.JournalEntryTable.Cols.SOUNDDATAPATH,
        journalEntry.getSoundDataPath());
