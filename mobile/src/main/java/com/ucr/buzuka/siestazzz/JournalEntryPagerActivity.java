 ...
 * ========================================================================
 * JournalEntryPagerActivity.java allows the user to swipe left or right to
 * view the next or previous journal entry.
 *
 */

public class JournalEntryPagerActivity extends AppCompatActivity {
    private static final String EXTRA_JOURNAL_ENTRY_ID = "com.buzuka.android.siestazzz.journal_entry_id";
